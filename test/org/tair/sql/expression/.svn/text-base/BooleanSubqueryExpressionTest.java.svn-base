...
/**
 * Tests the BooleanSubqueryExpression class.
 * 
 ...
 * subquery table must have two columns, column_1 VARCHAR and column_2 INTEGER.
 ...
 */
public class BooleanSubqueryExpressionTest extends ConnectionTest {
  /** Logger for this class */
  private static final Logger logger =
    Logger.getLogger(BooleanSubqueryExpressionTest.class);
  /** Test column name */
  ...
  private static final String SUBQUERY_TABLE = "BooleanSubqueryTest";
  /** Test correlation name for subquery table */
  private static final String SUBQUERY_CORR = "t";

  /**
   * Test method for
   * {@link org.tair.sql.expression.BooleanSubqueryExpression#BooleanSubqueryExpression()}
   * .
   */
  @Test
  public void testBooleanSubqueryExpression() {
    BooleanSubqueryExpression expr = new BooleanSubqueryExpression();
    assertTrue("Could not create BooleanSubqueryExpression", expr != null);
  }

  /**
   * Test method for
   * {@link org.tair.sql.expression.BooleanSubqueryExpression#BooleanSubqueryExpression(org.tair.sql.expression.IExpression, java.lang.String)}
   * .
   */
  @Test
  public void testBooleanSubqueryExpressionIExpressionString() {
    BooleanExpression bdExpr = new BooleanExpression(COL1, ALIAS1);
    BooleanSubqueryExpression expr =
      new BooleanSubqueryExpression(bdExpr, SUBQUERY_TABLE);
  ...
  /**
   * Test method for
   * {@link org.tair.sql.expression.BooleanSubqueryExpression#BooleanSubqueryExpression(org.tair.sql.expression.IExpression, java.lang.String, java.lang.String)}
   * .
   */
  @Test
  public void testBooleanSubqueryExpressionIExpressionStringString() {
    BooleanExpression bdExpr =
      new BooleanExpression(SUBQUERY_CORR + "." + COL1, ALIAS1);
    BooleanSubqueryExpression expr =
      new BooleanSubqueryExpression(bdExpr, SUBQUERY_TABLE, SUBQUERY_CORR);
    assertTrue("Could not create BooleanExpression", expr != null);
    String testString =
      "(SELECT "
          + SUBQUERY_CORR
  ...
  /**
   * Test method for
   * {@link org.tair.sql.expression.BooleanSubqueryExpression#getValue(java.sql.ResultSet, java.lang.String)}
   * .
   */
  @Test
  public void testGetValue() {
    ...
    String testString =
      "SELECT (SELECT t.column_1 AS COL1 FROM BooleanSubqueryTest t WHERE m.column_2 = t.column_2) AS subquery FROM "
          + TABLE
          + " "
          + MAIN_CORR;
    StringBuilder builder = new StringBuilder();
    ...
    try {
      ...
      if (rs.next()) {
        Boolean value = expr.getValue(rs);
        assertTrue("Could not get Boolean value", value != null);
  ...
  public void testGetSql() {
    ...
    BooleanExpression bdExpr =
      new BooleanExpression(correlationName + ".column_1", "col1");
    BooleanSubqueryExpression expr =
      new BooleanSubqueryExpression(bdExpr, "SubqueryTest", correlationName);
    assertTrue("Could not create BooleanExpression", expr != null);
