 ...
 */
public class BooleanSubqueryExpression extends
    ScalarSubqueryExpression<Boolean> {
  /**
   ...
   * construction
   */
  protected BooleanSubqueryExpression() {
    super();
  }
   ...
   */
  public BooleanSubqueryExpression(IExpression expression, String table) {
   ...
   *          a unique alias
   */
  public BooleanSubqueryExpression(IExpression expression,
                                   String table,
  ...
  @Override
  protected Boolean getValue(ResultSet rs, String alias) throws SQLException {
    Boolean valueBool = null;
    // Get the value as a String.
    String valueStr = rs.getString(alias);
    if (!rs.wasNull() && valueStr != null) {
      // Test for a "true" in one of several formats
