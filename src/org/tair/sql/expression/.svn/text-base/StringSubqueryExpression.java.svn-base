 ...
 */
public class StringSubqueryExpression extends ScalarSubqueryExpression<String> {
  /**
   ...
   * construction
   */
  protected StringSubqueryExpression() {
    super();
  }
   ...
   */
  public StringSubqueryExpression(IExpression expression, String table) {
   ...
   *          a unique alias
   */
  public StringSubqueryExpression(IExpression expression,
                                  String table,
  ...
  @Override
  protected String getValue(ResultSet rs, String alias) throws SQLException {
